...
/* __cs3_reset provides a means to programmatically reset the CPU.
   This function performs a soft reset, doing everything that is
   required to reinitialize the application.

   The __cs3_reset symbol is an alias to the real reset symbol.
   If you have a custom linker script that you wrote by hand, then
   this function will not exist, and you will need to call whatever
   symbol you defined as your reset symbol.  */

extern void __cs3_reset (void) __attribute ((noreturn));
...
/* dsram region */
extern unsigned char __cs3_region_start_dsram[] __attribute__((weak,aligned(8)));
extern unsigned char __cs3_region_size_dsram[] __attribute__((aligned(8)));
extern const unsigned char __cs3_region_init_dsram[] __attribute__((weak,aligned(8)));
extern const char __cs3_region_init_size_dsram __attribute__((weak,aligned(8)));
#define __cs3_region_init_size_dsram ((size_t)&__cs3_region_init_size_dsram)
extern const char __cs3_region_zero_size_dsram __attribute__((weak,aligned(8)));
#define __cs3_region_zero_size_dsram ((size_t)&__cs3_region_zero_size_dsram)

/* isram region */
extern unsigned char __cs3_region_start_isram[] __attribute__((weak,aligned(8)));
extern unsigned char __cs3_region_size_isram[] __attribute__((aligned(8)));
extern const unsigned char __cs3_region_init_isram[] __attribute__((weak,aligned(8)));
extern const char __cs3_region_init_size_isram __attribute__((weak,aligned(8)));
#define __cs3_region_init_size_isram ((size_t)&__cs3_region_init_size_isram)
extern const char __cs3_region_zero_size_isram __attribute__((weak,aligned(8)));
#define __cs3_region_zero_size_isram ((size_t)&__cs3_region_zero_size_isram)
