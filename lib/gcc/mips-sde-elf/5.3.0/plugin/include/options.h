...
enum opt_code
{
  ...
  OPT_mabs_ = 1146,                          /* -mabs= */
  OPT_march_ = 1147,                         /* -march= */
  OPT_mbranch_cost_ = 1148,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1149,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1150,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1151,                /* -mcode-readable= */
  /* OPT_mcode_xonly = 1152, */              /* -mcode-xonly */
  OPT_mcompact_eh = 1153,                    /* -mcompact-eh */
  OPT_mdebug = 1154,                         /* -mdebug */
  OPT_mdebugd = 1155,                        /* -mdebugd */
  OPT_mdivide_breaks = 1156,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1157,                  /* -mdivide-traps */
  OPT_mdmx = 1158,                           /* -mdmx */
  OPT_mdouble_float = 1159,                  /* -mdouble-float */
  OPT_mdsp = 1160,                           /* -mdsp */
  OPT_mdspr2 = 1161,                         /* -mdspr2 */
  OPT_meb = 1162,                            /* -meb */
  OPT_mel = 1163,                            /* -mel */
  OPT_membedded_data = 1164,                 /* -membedded-data */
  OPT_meva = 1165,                           /* -meva */
  OPT_mexplicit_relocs = 1166,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1167,                  /* -mextern-sdata */
  OPT_mfix_24k = 1168,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1169,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1170,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1171,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1172,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1173,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1174,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1175,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1176,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1177,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1178,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1179,                 /* -mfp-exceptions */
  OPT_mfp32 = 1180,                          /* -mfp32 */
  OPT_mfp64 = 1181,                          /* -mfp64 */
  OPT_mfpxx = 1182,                          /* -mfpxx */
  OPT_mframe_header_opt = 1183,              /* -mframe-header-opt */
  OPT_mfused_madd = 1184,                    /* -mfused-madd */
  OPT_mgp32 = 1185,                          /* -mgp32 */
  OPT_mgp64 = 1186,                          /* -mgp64 */
  OPT_mgpopt = 1187,                         /* -mgpopt */
  OPT_mhard_float = 1188,                    /* -mhard-float */
  OPT_mimadd = 1189,                         /* -mimadd */
  OPT_minterlink_compressed = 1190,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1191,              /* -minterlink-mips16 */
  OPT_mips = 1192,                           /* -mips */
  OPT_mips16 = 1193,                         /* -mips16 */
  OPT_mips16e = 1194,                        /* -mips16e */
  OPT_mips3d = 1195,                         /* -mips3d */
  OPT_mllsc = 1196,                          /* -mllsc */
  OPT_mlocal_sdata = 1197,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1198,                    /* -mlong-calls */
  OPT_mlong32 = 1199,                        /* -mlong32 */
  OPT_mlong64 = 1200,                        /* -mlong64 */
  OPT_mlra = 1201,                           /* -mlra */
  OPT_mmad = 1202,                           /* -mmad */
  OPT_mmcount_ra_address = 1203,             /* -mmcount-ra-address */
  OPT_mmcu = 1204,                           /* -mmcu */
  OPT_mmemcpy = 1205,                        /* -mmemcpy */
  OPT_mmicromips = 1206,                     /* -mmicromips */
  OPT_mmt = 1207,                            /* -mmt */
  OPT_mnan_ = 1208,                          /* -mnan= */
  /* OPT_mno_data_in_code = 1209, */         /* -mno-data-in-code */
  OPT_mno_float = 1210,                      /* -mno-float */
  OPT_mno_flush_func = 1211,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1212,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1213,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1214,                     /* -mno-mips3d */
  OPT_modd_spreg = 1215,                     /* -modd-spreg */
  OPT_mpaired_single = 1216,                 /* -mpaired-single */
  OPT_mplt = 1217,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1218,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1219,               /* -mrelax-pic-calls */
  OPT_mshared = 1220,                        /* -mshared */
  OPT_msingle_float = 1221,                  /* -msingle-float */
  OPT_msmartmips = 1222,                     /* -msmartmips */
  OPT_msoft_float = 1223,                    /* -msoft-float */
  OPT_msplit_addresses = 1224,               /* -msplit-addresses */
  OPT_msym32 = 1225,                         /* -msym32 */
  OPT_msynci = 1226,                         /* -msynci */
  OPT_mtune_ = 1227,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1228,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1229,                          /* -mvirt */
  OPT_mvr4130_align = 1230,                  /* -mvr4130-align */
  OPT_mxgot = 1231,                          /* -mxgot */
  OPT_mxpa = 1232,                           /* -mxpa */
  OPT_n = 1233,                              /* -n */
  OPT_no_canonical_prefixes = 1234,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1235,              /* -no-integrated-cpp */
  OPT_noasmopt = 1236,                       /* -noasmopt */
  ...
  OPT_quiet = 1262,                          /* -quiet */
  OPT_r = 1263,                              /* -r */
  OPT_remap = 1264,                          /* -remap */
  OPT_s = 1265,                              /* -s */
  OPT_s_bc_abi = 1266,                       /* -s-bc-abi */
  OPT_save_temps = 1267,                     /* -save-temps */
  OPT_save_temps_ = 1268,                    /* -save-temps= */
  OPT_shared = 1269,                         /* -shared */
  OPT_shared_libgcc = 1270,                  /* -shared-libgcc */
  /* OPT_specs = 1271, */                    /* -specs */
  OPT_specs_ = 1272,                         /* -specs= */
  OPT_static = 1273,                         /* -static */
  OPT_static_libasan = 1274,                 /* -static-libasan */
  OPT_static_libgcc = 1275,                  /* -static-libgcc */
  OPT_static_libgcj = 1276,                  /* -static-libgcj */
  OPT_static_libgfortran = 1277,             /* -static-libgfortran */
  OPT_static_libgo = 1278,                   /* -static-libgo */
  OPT_static_liblsan = 1279,                 /* -static-liblsan */
  OPT_static_libmpx = 1280,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1281,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1282,               /* -static-libstdc++ */
  OPT_static_libtsan = 1283,                 /* -static-libtsan */
  OPT_static_libubsan = 1284,                /* -static-libubsan */
  /* OPT_std_c__03 = 1285, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1286, */                /* -std=c++0x */
  OPT_std_c__11 = 1287,                      /* -std=c++11 */
  OPT_std_c__14 = 1288,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1289, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1290, */                /* -std=c++1y */
  OPT_std_c__1z = 1291,                      /* -std=c++1z */
  OPT_std_c__98 = 1292,                      /* -std=c++98 */
  OPT_std_c11 = 1293,                        /* -std=c11 */
  ...
  OPT_std_f95 = 1302,                        /* -std=f95 */
  OPT_std_gnu = 1303,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1304, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1305, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1306,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1307,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1308, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1309, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1310,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1311,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1312,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1313, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1314, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1315,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1316,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1317, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1318, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1319,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1320, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1321, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1322, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1323,                     /* -std=legacy */
  OPT_symbolic = 1324,                       /* -symbolic */
  OPT_t = 1325,                              /* -t */
  OPT_time = 1326,                           /* -time */
  OPT_time_ = 1327,                          /* -time= */
  OPT_traditional = 1328,                    /* -traditional */
  OPT_traditional_cpp = 1329,                /* -traditional-cpp */
  OPT_trigraphs = 1330,                      /* -trigraphs */
  OPT_u = 1331,                              /* -u */
  OPT_undef = 1332,                          /* -undef */
  OPT_v = 1333,                              /* -v */
  OPT_version = 1334,                        /* -version */
  OPT_w = 1335,                              /* -w */
  OPT_wrapper = 1336,                        /* -wrapper */
  OPT_x = 1337,                              /* -x */
  OPT_z = 1338,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
